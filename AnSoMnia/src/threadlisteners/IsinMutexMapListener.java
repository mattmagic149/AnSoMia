 ...
 * component's <code>addIsinMutexMapListener<code> method. When
 * the isinMutexMap event occurs, that object's appropriate
 * method is invoked.
 *
 * @see IsinMutexMapEvent
 */
public class IsinMutexMapListener implements JobListener {
	...
	/**
	 * Instantiates a new isin mutex map listener.
	 *
	 * @param name the name
	 */
